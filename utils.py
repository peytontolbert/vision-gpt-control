...
def generate_and_execute_command(text_agent, nlp_mouse_controller, command_description):
    """Utility function to generate a command using TextAgent and execute it."""
    command = text_agent.generate_command(command_description)
    nlp_mouse_controller.execute_command(command)
    return command